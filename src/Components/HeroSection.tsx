    ...
    return (
        ...
        relative overflow-hidden mx-auto py-10 md:py-0 bg-slate-950">
            <div className=" p-4 relative z-10 w-full text-center">
                ...
                >Dive into our comprehensive music courses and transform your musical journey today. Wether your're a beginner or looking to refine your skills , join to unlock your true potential.</p>
                <div className="mt-4">
                    <Link href={"/courses"}>
                        <Button
